    ...
    partidos: [
      {
        ...
        longitud: -58.36,
        localidades: [
          { nombre: 'Avellaneda Centro', latitud: -34.66, longitud: -58.36 },
          ...
          { nombre: 'Piñeyro', latitud: -34.668, longitud: -58.381 },
          { nombre: 'Villa Domínico', latitud: -34.698, longitud: -58.327 },
        ],
      },
      {
        nombre: 'La Plata',
      ...
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'Monte Chingolo', latitud: -34.729, longitud: -58.359 },
          { nombre: 'Gerli', latitud: -34.692, longitud: -58.371 },
        ],
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'Turdera', latitud: -34.783, longitud: -58.401 },
          { nombre: 'Villa Centenario', latitud: -34.742, longitud: -58.432 },
          { nombre: 'Ingeniero Budge', latitud: -34.708, longitud: -58.448 },
          { nombre: 'Villa Fiorito', latitud: -34.694, longitud: -58.439 },
        ],
      },
      {
      ...
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'José María Ezeiza', latitud: -34.848, longitud: -58.517 },
        ],
      },
      {
        nombre: 'San Vicente',
      ...
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'José Mármol', latitud: -34.787, longitud: -58.378 },
          { nombre: 'San José', latitud: -34.773, longitud: -58.344 },
          { nombre: 'Malvinas Argentinas', latitud: -34.821, longitud: -58.424 },
          { nombre: 'Ministro Rivadavia', latitud: -34.851, longitud: -58.361 },
          { nombre: 'San Francisco Solano', latitud: -34.783, longitud: -58.318 },
        ],
      },
      {
        nombre: 'Quilmes',
        ...
        localidades: [
          ...
          { nombre: 'Villa La Florida', latitud: -34.768, longitud: -58.303 },
        ],
      },
      {
        nombre: 'Berazategui',
      ...
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'Zeballos', latitud: -34.805, longitud: -58.257 },
          { nombre: 'Villa Brown', latitud: -34.852, longitud: -58.261 },
        ],
      },
    ],
  },
    ...
    partidos: [
      {
        ...
        longitud: -58.381,
        localidades: [
          { nombre: 'Agronomía', latitud: -34.593, longitud: -58.487 },
          { nombre: 'Almagro', latitud: -34.61, longitud: -58.42 },
          { nombre: 'Balvanera', latitud: -34.61, longitud: -58.401 },
          { nombre: 'Barracas', latitud: -34.64, longitud: -58.38 },
          { nombre: 'Belgrano', latitud: -34.562, longitud: -58.456 },
          { nombre: 'Boedo', latitud: -34.628, longitud: -58.416 },
          { nombre: 'Caballito', latitud: -34.618, longitud: -58.442 },
          { nombre: 'Chacarita', latitud: -34.587, longitud: -58.456 },
          { nombre: 'Coghlan', latitud: -34.561, longitud: -58.472 },
          { nombre: 'Colegiales', latitud: -34.575, longitud: -58.451 },
          { nombre: 'Constitución', latitud: -34.627, longitud: -58.386 },
          { nombre: 'Flores', latitud: -34.632, longitud: -58.465 },
          { nombre: 'Floresta', latitud: -34.628, longitud: -58.484 },
          { nombre: 'La Boca', latitud: -34.636, longitud: -58.363 },
          { nombre: 'La Paternal', latitud: -34.601, longitud: -58.468 },
          { nombre: 'Liniers', latitud: -34.643, longitud: -58.516 },
          { nombre: 'Mataderos', latitud: -34.656, longitud: -58.502 },
          { nombre: 'Monte Castro', latitud: -34.62, longitud: -58.503 },
          { nombre: 'Monserrat', latitud: -34.613, longitud: -58.383 },
          { nombre: 'Nueva Pompeya', latitud: -34.653, longitud: -58.419 },
          { nombre: 'Núñez', latitud: -34.545, longitud: -58.464 },
          { nombre: 'Palermo', latitud: -34.588, longitud: -58.43 },
          { nombre: 'Parque Avellaneda', latitud: -34.645, longitud: -58.477 },
          { nombre: 'Parque Chacabuco', latitud: -34.634, longitud: -58.443 },
          { nombre: 'Parque Chas', latitud: -34.583, longitud: -58.479 },
          { nombre: 'Parque Patricios', latitud: -34.636, longitud: -58.406 },
          { nombre: 'Puerto Madero', latitud: -34.611, longitud: -58.363 },
          { nombre: 'Recoleta', latitud: -34.588, longitud: -58.393 },
          { nombre: 'Retiro', latitud: -34.593, longitud: -58.376 },
          { nombre: 'Saavedra', latitud: -34.552, longitud: -58.487 },
          { nombre: 'San Cristóbal', latitud: -34.623, longitud: -58.401 },
          { nombre: 'San Nicolás', latitud: -34.604, longitud: -58.381 },
          { nombre: 'San Telmo', latitud: -34.621, longitud: -58.373 },
          { nombre: 'Vélez Sársfield', latitud: -34.628, longitud: -58.497 },
          { nombre: 'Versalles', latitud: -34.626, longitud: -58.522 },
          { nombre: 'Villa Crespo', latitud: -34.598, longitud: -58.443 },
          { nombre: 'Villa del Parque', latitud: -34.606, longitud: -58.49 },
          { nombre: 'Villa Devoto', latitud: -34.598, longitud: -58.512 },
          { nombre: 'Villa General Mitre', latitud: -34.608, longitud: -58.472 },
          { nombre: 'Villa Lugano', latitud: -34.671, longitud: -58.473 },
          { nombre: 'Villa Luro', latitud: -34.638, longitud: -58.504 },
          { nombre: 'Villa Ortúzar', latitud: -34.58, longitud: -58.469 },
          { nombre: 'Villa Pueyrredón', latitud: -34.577, longitud: -58.502 },
          { nombre: 'Villa Real', latitud: -34.618, longitud: -58.523 },
          { nombre: 'Villa Riachuelo', latitud: -34.689, longitud: -58.462 },
          { nombre: 'Villa Santa Rita', latitud: -34.613, longitud: -58.483 },
          { nombre: 'Villa Soldati', latitud: -34.665, longitud: -58.446 },
          { nombre: 'Villa Urquiza', latitud: -34.572, longitud: -58.486 },
        ],
      },
    ],
  },
    ...
    partidos: [
      {
        ...
        localidades: [
          ...
          { nombre: 'Florida Oeste', latitud: -34.537, longitud: -58.513 },
          { nombre: 'Carapachay', latitud: -34.53, longitud: -58.55 },
          { nombre: 'La Lucila', latitud: -34.498, longitud: -58.486 },
          { nombre: 'Villa Martelli', latitud: -34.551, longitud: -58.508 },
        ],
      },
      {
        nombre: 'San Isidro',
        ...
        localidades: [
          ...
          { nombre: 'Acasusso', latitud: -34.478, longitud: -58.506 },
        ],
      },
      {
        nombre: 'San Fernando',
      ...
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'Rincón de Milberg', latitud: -34.414, longitud: -58.599 },
          { nombre: 'Dique Luján', latitud: -34.367, longitud: -58.682 },
          { nombre: 'Ricardo Rojas', latitud: -34.45, longitud: -58.667 },
        ],
      },
      {
        nombre: 'Escobar',
        ...
        localidades: [
          ...
          { nombre: 'Maquinista F. Savio', latitud: -34.416, longitud: -58.767 },
        ],
      },
      {
        nombre: 'Pilar',
        ...
        localidades: [
          ...
          { nombre: 'Presidente Derqui', latitud: -34.479, longitud: -58.841 },
          { nombre: 'Manuel Alberti', latitud: -34.456, longitud: -58.789 },
          { nombre: 'Fatima', latitud: -34.428, longitud: -59.006 },
          { nombre: 'Manzanares', latitud: -34.456, longitud: -59.001 },
      ...
      },
      {
        ...
        longitud: -58.768,
        localidades: [
          { nombre: 'José C. Paz', latitud: -34.515, longitud: -58.768 },
          { nombre: 'Del Viso', latitud: -34.444, longitud: -58.802 },
        ],
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'Ingeniero Adolfo Sourdeaux', latitud: -34.516, longitud: -58.666 },
          { nombre: 'Tierras Altas', latitud: -34.488, longitud: -58.736 },
          { nombre: 'Villa de Mayo', latitud: -34.511, longitud: -58.683 },
        ],
      },
      {
        nombre: 'San Miguel',
        ...
        longitud: -58.712,
        localidades: [
          { nombre: 'San Miguel', latitud: -34.542, longitud: -58.712 },
          { nombre: 'Bella Vista', latitud: -34.562, longitud: -58.689 },
          { nombre: 'Muñiz', latitud: -34.548, longitud: -58.701 },
          { nombre: 'Santa María', latitud: -34.528, longitud: -58.742 },
        ],
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'Billinghurst', latitud: -34.582, longitud: -58.563 },
          { nombre: 'San Lynch', latitud: -34.586, longitud: -58.528 },
          { nombre: 'Villa Maipú', latitud: -34.573, longitud: -58.518 },
          { nombre: 'Villa Bosch', latitud: -34.588, longitud: -58.552 },
        ],
      },
    ],
  },
    ...
    partidos: [
      {
        ...
        localidades: [
          ...
          { nombre: 'Gregorio de Laferrere', latitud: -34.754, longitud: -58.587 },
          { nombre: 'Aldo Bonzi', latitud: -34.71, longitud: -58.519 },
          { nombre: 'Villa Luzuriaga', latitud: -34.671, longitud: -58.588 },
          { nombre: 'Tapiales', latitud: -34.704, longitud: -58.508 },
          { nombre: 'Villa Madero', latitud: -34.688, longitud: -58.496 },
          { nombre: 'Rafael Castillo', latitud: -34.712, longitud: -58.619 },
          { nombre: '20 de Junio', latitud: -34.783, longitud: -58.705 },
        ],
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'Santos Lugares', latitud: -34.601, longitud: -58.541 },
          { nombre: 'Villa Bosch', latitud: -34.588, longitud: -58.552 },
          { nombre: 'Martin Coronado', latitud: -34.591, longitud: -58.581 },
          { nombre: 'Loma Hermosa', latitud: -34.571, longitud: -58.589 },
          { nombre: 'Villa Raffo', latitud: -34.618, longitud: -58.529 },
        ],
      },
      {
        nombre: 'Hurlingham',
      ...
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'El Palomar', latitud: -34.61, longitud: -58.583 },
          { nombre: 'Villa Sarmiento', latitud: -34.638, longitud: -58.572 },
        ],
      },
      {
        nombre: 'Ituzaingó',
      ...
      },
      {
        ...
        localidades: [
          ...
          { nombre: 'Libertad', latitud: -34.698, longitud: -58.683 },
          { nombre: 'Mariano Acosta', latitud: -34.707, longitud: -58.788 },
          { nombre: 'Pontevedra', latitud: -34.745, longitud: -58.689 },
        ],
      },
      {
        nombre: 'Moreno',
        ...
        localidades: [
          ...
          { nombre: 'Cuartel V', latitud: -34.551, longitud: -58.835 },
          { nombre: 'La Reja', latitud: -34.64, longitud: -58.815 },
        ],
      },
      {
        ...
        longitud: -58.954,
        localidades: [
          { nombre: 'General Rodríguez', latitud: -34.607, longitud: -58.954 },
        ],
      },
      {
        nombre: 'Marcos Paz',
        ...
        longitud: -58.834,
        localidades: [
          { nombre: 'Marcos Paz', latitud: -34.771, longitud: -58.834 },
        ],
      },
    ],
  },
