export const styles = {
  ...
  destacada: "absolute top-2.5 right-2.5 z-10 bg-amber-400/30 text-slate-950 text-[11px] font-black p-1 rounded-lg shadow-lg flex items-center justify-center border border-amber-300/80",
