...
export const styles = {
  ...
  badgeOperation: "absolute top-4 right-4 z-10 font-spartan font-bold uppercase tracking-wider text-xs px-3 py-1.5 rounded-md shadow-sm",
  ...
  priceBlock: "bg-brand-dark/95 text-white px-4 py-2 rounded-lg font-spartan font-bold text-md tracking-wider uppercase flex justify-between items-center",
