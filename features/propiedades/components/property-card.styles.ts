export const styles = {
  ...
  destacada: "absolute top-2.5 right-2.5 z-10 bg-amber-400/50 text-slate-950 text-[11px] font-black p-1.5 rounded-full shadow-md flex items-center justify-center border border-amber-300",
